...
func ToSliceE(i interface{}) ([]interface{}, error) {
	...
	case []map[string]interface{}:
		...
		return s, nil
	default:
		return s, fmt.Errorf("unable to conv %#v of type %T to []interface{}", i, i)
	}
}

func toSliceE[T any](i any, fn func(any) (T, error)) ([]T, error) {
	if i == nil {
		return []T{}, fmt.Errorf("unable to conv %#v of type %T to %T", i, i, []T{})
	}
...
func ToStringSliceE(i interface{}) ([]string, error) {
	...
	case interface{}:
		str, err := ToStringE(v)
		if err != nil {
			return a, fmt.Errorf("unable to conv %#v of type %T to []string", i, i)
		}
