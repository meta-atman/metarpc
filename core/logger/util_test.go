...
func TestPrettyCaller(t *testing.T) {
	tests := []struct {
		...
		{
			name: "long path",
			file: "github.com/meta-atman/metarpc/core/logger/util_test.go",
			line: 12,
			want: "logger/util_test.go:12",
		},
		{
			name: "local path",
			file: "/Users/kevin/go-zero/core/logger/util_test.go",
			line: 1234,
			want: "logger/util_test.go:1234",
		},
	}
